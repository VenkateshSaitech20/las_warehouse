...
//
//     final workOrdersModel = workOrdersModelFromJson(jsonString);

import 'dart:convert';

WorkOrdersModel workOrdersModelFromJson(String str) =>
    WorkOrdersModel.fromJson(json.decode(str));

String workOrdersModelToJson(WorkOrdersModel data) =>
    json.encode(data.toJson());

class WorkOrdersModel {
  bool? result;
  List<WorkOrdersData>? message;
  ...
  factory WorkOrdersModel.fromJson(Map<String, dynamic> json) =>
      WorkOrdersModel(
        result: json["result"],
        message: json["message"] == null
            ? []
            : List<WorkOrdersData>.from(
                json["message"]!.map((x) => WorkOrdersData.fromJson(x)),
              ),
      );
...
class WorkOrdersData {
  ...
  factory WorkOrdersData.fromJson(Map<String, dynamic> json) => WorkOrdersData(
        id: json["_id"],
        reqId: json["reqId"],
